...
export default function SlideOversCreateProj() {
  ...
  //  <div className='flex flex-row items-center justify-start space-x-3 my-3' >
  //     <motion.div 
  //       className='bg-amber-600 w-[fit-content] p-3 rounded-md ring-1 ring-amber-200 cursor-pointer ' >
  //       hoverMe
  //     </motion.div>
  //     <motion.div 
  //       className='bg-amber-600 w-[fit-content] p-3 rounded-md ring-1 ring-amber-200 cursor-pointer' >
