...
const navigation = [
  ...
  { name: 'Transaction History', href: '#', icon: ArrowPathIcon,  },
  { name: 'Chat', href: '#', icon: ChatBubbleLeftRightIcon,  },
  { name: 'Shipping address', href: '#', icon: MapPinIcon,  },
  { name: 'Profile', href: '#', icon: UserIcon,  },
  { name: 'Settings', href: '#', icon: Cog8ToothIcon, },
  { name: 'Card', href: '#', icon: ShoppingCartIcon, },
  { name: 'Order History', href: '#', icon: ArrowPathIcon, },
]
...
export default function SettingsWithSideBarConstraint() {
              ...
              <div className="space-y-1">
                {navigation.map((item, i) => (
                  ...
                  >
                    <item.icon
                      className={classNames(
                        Current === i ? 'text-purple-500' : 'text-gray-400 group-hover:text-gray-500',
